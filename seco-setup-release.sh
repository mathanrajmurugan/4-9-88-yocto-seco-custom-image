...
patch -Np1 -r - sources/meta-fsl-bsp-release/imx/meta-bsp/recipes-security/optee-imx/optee-os-imx_git.bb < sources/meta-seco-bsp-release/patches/optee-os-imx-while-building-machine-doesnot-recognize-failure.patch
...
echo "BBLAYERS += \" \${BSPDIR}/sources/meta-seco-bsp-release-bsp7 \"" >> $BUILD_DIR/conf/bblayers.conf
